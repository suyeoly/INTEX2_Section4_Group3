...
public partial class LegoInfoContext : DbContext
{
    ...
    public virtual DbSet<LineItemsCsv> LineItemsCsvs { get; set; }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlite("Data Source=LegoInfo.db");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<LineItemsCsv>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("LineItems.csv");
